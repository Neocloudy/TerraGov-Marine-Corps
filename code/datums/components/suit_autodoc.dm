...
/datum/component/suit_autodoc/proc/treat_injuries()
	...
	var/brute = inject_chems(brute_chems, wearer, COOLDOWN_CHEM_BRUTE, wearer.get_brute_loss(), damage_threshold, "Trauma treatment", "Significant tissue burns detected. Restorative injection")
