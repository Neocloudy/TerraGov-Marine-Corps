...
/datum/preferences/proc/load_preferences()
	...
	READ_FILE(S["hear_looc_offscreen_as_staff"], hear_looc_offscreen_as_staff)
	...
	hear_looc_offscreen_as_staff = sanitize_integer(hear_looc_offscreen_as_staff, FALSE, TRUE, initial(hear_looc_offscreen_as_staff))
	return TRUE
...
/datum/preferences/proc/save_preferences()
	...
	WRITE_FILE(S["hear_looc_offscreen_as_staff"], hear_looc_offscreen_as_staff)
