...
/datum/preferences/ui_data(mob/user)
	...
	switch(tab_index)
		...
		if(GAME_SETTINGS)
			...
			data["hear_looc_offscreen_as_staff"] = hear_looc_offscreen_as_staff
		if(KEYBIND_SETTINGS)
			data["is_admin"] = user.client?.holder ? TRUE : FALSE
...
/datum/preferences/ui_act(action, list/params, datum/tgui/ui)
	...
	switch(action)
		...
		if("hear_looc_offscreen_as_staff")
			hear_looc_offscreen_as_staff = !hear_looc_offscreen_as_staff
